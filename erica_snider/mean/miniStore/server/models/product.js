...
var productSchema = new mongoose.Schema({
  name: {
    type: String,
    presence: [true, "Product name cannot be blank."],
    minlength: [2, "Product name is too short."],
    maxlength: [222, "Product name is too long."],
  },
  imageUrl: {
    type: String,
    presence: [true, "Image URL cannot be blank."],
  ...
  description: {
    type: String,
    presence: [true, "Description cannot be blank."],
    minlength: [2, "Description is too short."],
    maxlength: [2222, "Description is too long."],
  },
  quantity: {
    type: Number,
    presence: [true, "Quantity cannot be blank."],
  },
  orders: [{
